...
This document can be used to replicate the quantitative lithic analyses presented in the paper "Multiple hominin dispersals into Southwest Asia over the last 400,000 years" by Groucutt et al. [2020](http://DOI). All analyses were conducted in R. It includes a corrected dataset (LP_corrected.csv).
...
```{r label="PCA Results for the corrected LP data"}
sample_name <- "LP"
